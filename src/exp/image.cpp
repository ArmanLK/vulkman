...
class ImageDemo {
  ...
  private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("assets/image_vert.spv");
        auto fragShaderCode = readFile("assets/image_frag.spv");
    ...
    void createTextureImage() {
        ...
        stbi_uc *pixels = stbi_load("texture/some_random_image.png", &texWidth,
    ...
    static void framebufferResizeCallback(GLFWwindow *window, int width,
                                          int height) {
        auto app =
            reinterpret_cast<ImageDemo *>(glfwGetWindowUserPointer(window));
